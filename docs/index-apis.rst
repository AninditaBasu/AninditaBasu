...
.. csv-table::
   ...
   :doc:`internetarchive/index`, "This is a Python interface for interacting with various archive.org services.", "--", ":doc:`tutorial-find-identifier-item`, :doc:`tutorial-read-item-metadata`, :doc:`tutorial-create-item`"
   :doc:`S3-like API <ias3>`, "This API is for creating items, uploading files, and managing metadata on an Amazon S3-like server.", "--", "--"
   :doc:`metadata`, "This API is for fetching the entire metadata of an item in a single transaction.", "`Item Metadata API reference <./_static/item_api.html>`_", "--"
   :doc:`md-read`, "This API is for fetching metadata.", "--", "--"
   :doc:`md-write`, "This API is for updating metadata.", "--", "--"
